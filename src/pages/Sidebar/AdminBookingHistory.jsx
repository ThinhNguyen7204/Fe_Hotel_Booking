  ...
  return (
    <section className="p-4 md:p-8 bg-slate-50/30 min-h-screen w-full min-w-0">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="font-semibold text-2xl text-slate-800">Booking History</h2>
          <p className="text-sm text-slate-500">Track and filter client check-ins and payments.</p>
        </div>
      </div>

      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden p-6 mb-6">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <div className="w-full sm:w-[300px]">
            <input
              ...
              className="w-full h-[42px] border border-slate-200 bg-white px-4 py-2 rounded-xl text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-sm shadow-sm"
            />
          </div>

          <div className="w-full sm:w-[200px] h-[42px] flex items-center border border-slate-200 rounded-xl px-2 bg-white focus-within:ring-2 focus-within:ring-indigo-500/20 focus-within:border-indigo-500 transition-all shadow-sm">
            <CheckStartDate
